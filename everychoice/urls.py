...
schema_view_v1 = get_schema_view(
    openapi.Info(
        title="EveryChoice Open API",
        default_version='v1',
        description="안녕하세요. doctorf의 Open API 문서 페이지 입니다.",
        terms_of_service="https://www.google.com/policies/terms/",
        contact=openapi.Contact(email="doctorf@naver.com"),
        license=openapi.License(name="doctorf's CodeFactory"),
    ),
    validators=['flex'],  # 'ssv'],
    public=True,
